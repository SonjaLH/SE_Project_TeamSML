...
if (isset($_SESSION["user-email"])) {
    if (($_SESSION["user-email"]) == "" and $_SESSION["user-type"] != 'c') {
    ...
    <div class="container pt-5 ">
        ...
        <div class="row  ">
            ...
            <div class="col-lg-12 col-md-6 col-sm-12">
                <h6 class="display-6"> My Bookings
                ...
                $myBookings = $bookingService->getMyBookings($userByEmail["user_id"])
                                ...
                                <div class="abc scroll">
                                    <table width="93%" class="sub-table scrolldown" border="0">
                                        ...
                                        if ($myBookings->num_rows == 0) {
                                            ...
                                            for ($x = 0; $x < $myBookings->num_rows; $x++) {
                                                $row = $myBookings->fetch_assoc();
                                                $carid = $row["car_id"];
...
<td> &nbsp;' . substr($carid, 0, 30) . '</td>
                        ...
                        //                                // Access article properties as needed
                        ...
                        //                                $category_name = $database->query("select category_name from categories where category_id=$category_id")->fetch_assoc()["category_name"];
                        //
                        //                                echo " <div class='col-12 '>"
                        //                                    . "   <div class='card border-0 text-wrap shadow-1 '>"
                        //                                    . " <div class='bg-image hover-overlay ripple' data-mdb-ripple-color='light'></div>"
                        //                                    . "<div class='card-body d-block'><div class='row'><div class='col-9'><h5 class='card-title text-wrap '>" . $title . "</h5> "
                        //                                    . "<p class='card-text text-wrap'>" . $sub_title . " </p></div>"
                        //                                    . "<div class='col-3'> <form action='../samples/article.php'  method='post'>"
                        ...
                        //                                    . "<button  type='submit' name='see_article' class='btn btn-outline-primary form-control btn-block mb-4'>See More</button> </form>"
                        //                                    . "<form   method='post'>"
                        //                                    . "<input type='hidden' name='article_id' value='$article_id'>"
                        //                                    . " <button  type='submit'  name='delete_article' class='btn btn-danger form-control btn-block mb-4'>Delete</button> </form></div></div>"
                        //                                    . "</div ><div class='row'> <div class='col-12'> <div class='card-footer' > $created_at</div></div > </div></div></div > <br><hr> ";
                        //                            }
                        //
                        //                        } else {
