        ...
        <nav id="navbar" class="navbar order-last order-lg s me-5">
            <ul>
                ...
                <li class="nav-item dropdown">
                 <a class="nav-link scrollto " href="bookings.php">Bookings</a>
                </li>
    ...
    <div class="container pt-5 ">
        ...
        <div class="row  ">
            ...
            <div class="col-lg-12 col-md-6 col-sm-12">
                <h6 class="display-6"> Cars</h6>
                <hr>
                <form action="add_car.php" method='post'><br>
                    <button type='submit' name='delete_article'
                            class='btn btn-outline-info form-control btn-block mb-4'>Add
                    </button>
                </form>
                                ...
                                <div class="card-body d-block">
                                    ...
                                    <p class="card-text text-wrap">
                                     ...
                                     <a href="../car.php?action=view&id=' . $carid . '" class="non-style-link"><button  class="btn-outline-primary btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="delete-car.php?action=drop&id=' . $carid . ' " class="non-style-link"><button  class="btn-outline-danger btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                             </div>
